...
namespace DAL.Migrations
{
    ...
    [Migration("20210531064048_FixPermissionTableContext")]
    partial class FixPermissionTableContext
    {
            ...
            modelBuilder.Entity("DAL.Models.TeamMember", b =>
                {
                    ...
                    b.Property<int?>("TempMemberUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.TeamMember", b =>
                {
                    ...
                    b.HasOne("DAL.Models.TemporaryProjectMember", "TempMemberUser")
                        .WithMany()
                        .HasForeignKey("TempMemberUserId");

                    b.Navigation("MemberUser");

                    b.Navigation("Team");

                    b.Navigation("TempMemberUser");
                });
