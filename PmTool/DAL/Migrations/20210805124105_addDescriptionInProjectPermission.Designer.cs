...
namespace DAL.Migrations
{
    ...
    [Migration("20210805124105_addDescriptionInProjectPermission")]
    partial class addDescriptionInProjectPermission
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Challenge", b =>
                {
                    ...
                    b.Property<double?>("TotalWorkingDurationInMinutes")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DAL.Models.FAQ", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.NotificationField", b =>
                {
                    b.Property<int>("NotificationFieldId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("NotificationFieldTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("NotificationFieldId");

                    b.HasIndex("CardId");

                    b.HasIndex("ChallengeId");

                    b.HasIndex("NotificationFieldTypeId");

                    b.HasIndex("NotificationId");

                    b.HasIndex("ProjectId");

                    b.ToTable("NotificationField");
                });

            modelBuilder.Entity("DAL.Models.NotificationFieldType", b =>
                {
                    b.Property<int>("NotificationFieldTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("NotificationFieldTypeId");

                    b.ToTable("NotificationFieldType");
                });
            ...
            modelBuilder.Entity("DAL.Models.ProjectMember", b =>
                {
                    ...
                    b.Property<Guid?>("ProjectMemberPublicId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newid()");
            ...
            modelBuilder.Entity("DAL.Models.ProjectPermission", b =>
                {
                    ...
                    b.Property<string>("ProjectPermissionDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProjectPermissionDisplayName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.TeamMember", b =>
                {
                    ...
                    b.Property<Guid?>("TeamMemberPublicId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newid()");
            ...
            modelBuilder.Entity("DAL.Models.UserChallengeDuration", b =>
                {
                    b.Property<int>("UserChallengeDurationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("UserChallengeDurationId");

                    b.HasIndex("ChallengeId");

                    b.HasIndex("UserId");

                    b.ToTable("UserChallengeDuration");
                });

            modelBuilder.Entity("DAL.Models.UserFeedback", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.Notification", b =>
                {
                    ...
                    b.HasOne("DAL.Models.NotificationType", "NotificationType")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.NotificationField", b =>
                {
                    ...
                    b.HasOne("DAL.Models.NotificationFieldType", "NotificationFieldType")
                        .WithMany()
                        .HasForeignKey("NotificationFieldTypeId");

                    b.HasOne("DAL.Models.Notification", "Notification")
                        .WithMany()
                    ...
                    b.Navigation("NotificationFieldType");
            ...
            modelBuilder.Entity("DAL.Models.ProjectMemberPermission", b =>
                {
                    ...
                    b.HasOne("DAL.Models.ProjectPermission", "ProjectPermission")
                        .WithMany()
